 ...
 * @property integer $timeout The number of seconds after which data will be seen
 * as 'garbage' and cleaned up, defaults to 1440 seconds.
...
class CHttpSession extends CApplicationComponent implements IteratorAggregate,ArrayAccess,Countable {
	...
	/**
	 * @param string $value the session name for the current session, must be an
	...
	/**
	 * @param string $value how to use cookie to store session ID. Valid values
	...
	/**
	 * @return float the probability (percentage) that the gc (garbage collection)
	...
	/**
	 * @param float $value the probability (percentage) that the gc (garbage
	...
	/**
	 * @return boolean whether transparent sid support is enabled or not, defaults to
	 * false.
	 */
	...
	/**
	 * @param integer $value the number of seconds after which data will be seen as
	 ...
	 * @param mixed $defaultValue the default value to be returned when the session
	 ...
	 * @return mixed the element at the offset, null if no element is found at the
	 * offset
	 */
